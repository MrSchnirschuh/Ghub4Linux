"""Main entry point for GLinux application."""
...
class GLinuxApplication(Adw.Application):
    """Main GLinux application."""

    def __init__(self):
        """Initialize the application."""
        super().__init__(
            application_id="io.github.glinux",
    ...
    def _on_preferences(self, _action: Gio.SimpleAction, _param: Any) -> None:
        ...
        minimized_row.set_subtitle("Start GLinux minimized to system tray")
        ...
        autostart_row.set_subtitle("Start GLinux when you log in")
        ...
        tray_row.set_subtitle("Keep GLinux running in the system tray when closed")
    ...
    def _on_about(self, _action: Gio.SimpleAction, _param: Any) -> None:
        ...
        about = Adw.AboutWindow(
            ...
            application_name="GLinux",
            application_icon="input-gaming-symbolic",
            developer_name="GLinux Contributors",
            version="0.1.0",
            developers=["GLinux Contributors"],
            copyright="© 2024 GLinux Contributors",
